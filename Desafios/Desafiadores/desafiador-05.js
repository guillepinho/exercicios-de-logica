...
function magicWand(wizard, wand) {
  const wizardsNWands = {
    HarryPotter: 'Azevinho e Pena de Fênix',
    RonyWeasley: 'Salgueiro e Pelo de Unicórnio',
    HermioneGranger: 'Videira e Fibra de Dragão',
    AlvoDumbledore: 'Salgueiro e Pelo de Testrálio',
    BelatrizLestrange: 'Nogueira e Fibra de Dragão'
  };
  const checkWand = wizard.replace(/\s+/g, '');
  const wizardWand = wizardsNWands[checkWand];
